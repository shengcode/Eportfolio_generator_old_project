...
import static ssm.StartupConstants.CSS_CLASS_SELECTED_SLIDE_TEXTFIELD;
...
public class SlideShowMakerView {
	...
	workspace = new HBox();
	workspace.getStylesheets().add("slide_workspace");
	// THIS WILL GO IN THE LEFT SIDE OF THE SCREEN
	...
	ssmPane = new BorderPane();
        ssmPane.getStylesheets().add("SSpaneStyle");
	...
	titleTextField.getStylesheets().add(CSS_CLASS_SELECTED_SLIDE_TEXTFIELD);
